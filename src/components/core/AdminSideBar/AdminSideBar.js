                ...
                <div className="flex-1 px-3 bg-white divide-y space-y-1">
                    <ul className="space-y-2 pb-2">
                        ...
                        <li>
                            ...
                            <span className="ml-3 flex-1 whitespace-nowrap">Gestion des biens</span>
                            </a>
                        </li>
                        <li>
                            ...
                            <span className="ml-3 flex-1 whitespace-nowrap">Gestion des commentaires</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                            ...
                            <span className="ml-3 flex-1 whitespace-nowrap">Gestion catégories</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                        ...
                        <li>
                            ...
                            <span className="ml-3 flex-1 whitespace-nowrap">Se déconnecter</span>
                            </a>
                        </li>
                    </ul>
                </div>
